...
_DEFAULT_REVIEW_ROOT = os.environ.get(
    "HOST_PREDICTION_REVIEW_DIR",
    "/path/to/HostPredictionReview-main"
)
...
def main():
    ...
    if not os.path.isfile(eval_full):
        sys.exit(f"[ERR] evaluate_full.py not found: {eval_full}\n"
                 ...
                 f"HostPredictionReview-main directory.")
    ...
    if tool == "php":
        ...
        r  = ef.compute_metrics("PHIST", sm, ground_truth, virus_ids,
                                n_labels=len(host_universe) or 223,
